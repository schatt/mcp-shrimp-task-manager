...
export const splitTasksSchema = z.object({
  ...
  tasks: z
    ...
    .describe("Structured task list. Each task should be atomic with clear acceptance criteria. Avoid trivial tasks; merge minor edits."),
...
export async function splitTasks({
  ...
  try {
    ...
    // Convert to batchCreateOrUpdateTasks format
