...
- **任務查看器工具**：完整的基於 React 的任務管理網頁界面
  ...
  - 開發時的熱模塊替換
  - 包含截圖的完整文檔
- 新增 ListRoots 協議支援並優化 DATA_DIR 配置方法 (99baa0f)
- 新增 WEB_PORT 環境變數以自訂 WebGUI 連接埠號碼 (8771a5b)
...
- 更新文檔以反映新的配置選項 (99baa0f, 8771a5b)

### 修復

- 修復 #56：新增可配置的 WebGUI 連接埠以避免連接埠衝突 (8771a5b)
